"""Tests for flywheel.payload."""

from __future__ import annotations

from datetime import datetime, timezone

from flywheel.payload import Payload
from flywheel.models import Job, JobState


def test_payload_snapshot_and_score() -> None:
    comp = Payload(name="payload")
    job = Job(
        job_id="j1",
        queue="default",
        payload={"n": 1},
    ...
    assert comp.explain(job)["component"] == "payload"


def test_payload_incr_and_history() -> None:
    comp = Payload()
