"""Tests for flywheel.snapshot."""

from __future__ import annotations

from datetime import datetime, timezone

from flywheel.snapshot import Snapshot
from flywheel.models import Job, JobState


def test_snapshot_snapshot_and_score() -> None:
    comp = Snapshot(name="snapshot")
    job = Job(
        job_id="j1",
        queue="default",
        payload={"n": 1},
    ...
    assert comp.explain(job)["component"] == "snapshot"


def test_snapshot_incr_and_history() -> None:
    comp = Snapshot()
