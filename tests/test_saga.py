"""Tests for flywheel.saga."""

from __future__ import annotations

from datetime import datetime, timezone

from flywheel.saga import Saga
from flywheel.models import Job, JobState


def test_saga_snapshot_and_score() -> None:
    comp = Saga(name="saga")
    job = Job(
        job_id="j1",
        queue="default",
    ...
    assert comp.explain(job)["component"] == "saga"


def test_saga_incr_and_history() -> None:
    comp = Saga()
