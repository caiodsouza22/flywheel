"""Tests for flywheel.health."""

from __future__ import annotations

from datetime import datetime, timezone

from flywheel.health import Health
from flywheel.models import Job, JobState


def test_health_snapshot_and_score() -> None:
    comp = Health(name="health")
    job = Job(
        job_id="j1",
        queue="default",
        payload={"n": 1},
    ...
    assert comp.explain(job)["component"] == "health"


def test_health_incr_and_history() -> None:
    comp = Health()
