"""Tests for flywheel.report."""

from __future__ import annotations

from datetime import datetime, timezone

from flywheel.report import Report
from flywheel.models import Job, JobState


def test_report_snapshot_and_score() -> None:
    comp = Report(name="report")
    job = Job(
        job_id="j1",
        queue="default",
        payload={"n": 1},
    ...
    assert comp.explain(job)["component"] == "report"


def test_report_incr_and_history() -> None:
    comp = Report()
