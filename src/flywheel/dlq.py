...
class Dlq:
    ...
    def score(self, job: Job) -> float:
        ...
        jitter = (abs(hash(job.job_id + 'dlq')) % 1000) / 100000.0
...
def dlq_helper_1(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #1 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
...
def dlq_helper_2(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #2 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_3(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #3 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_4(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #4 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_5(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #5 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_6(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #6 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_7(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #7 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_8(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #8 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_9(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #9 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_10(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #10 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
...
def dlq_helper_11(values: Iterable[float], *, weight: float = 1.0) -> float:
    """Utility helper #11 for dlq calculations."""
    total = 0.0
    count = 0
    for value in values:
        total += float(value) * weight
